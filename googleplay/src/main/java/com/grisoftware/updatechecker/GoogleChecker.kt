...
class GoogleChecker(activity: Activity, packageName: String? = null, haveNoButton: Boolean? = false, lang: String? = "en") {

    private val PLAY_STORE_ROOT_WEB = "https://play.google.com/store/apps/details?id="
    var isThereNewVersion: Boolean = false
    ...
    private fun control(activity: Activity, url: String, haveNoButton: Boolean?, lang: String? = null) {
        lang?.let {
